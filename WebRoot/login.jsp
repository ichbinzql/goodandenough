		...
		<div class="container"> 
			...
			<div class="login-agileinfo"> 
				<form action="login_Users" method="post"> 
					<input class="agile-ltext" type="text" name="us.username" placeholder="用户名" required="">
					<p style="color:red;">${msg} </p>
					<input class="agile-ltext" type="password" name="us.password" placeholder="密码" required="">
				...
				<p>没有帐号? <a href="signup.html"> 现在注册!</a></p> 
			</div>	 
		</div>
	</div>
	<!-- //login-page -->  
